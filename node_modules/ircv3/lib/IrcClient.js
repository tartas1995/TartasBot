...
var IrcClient = /** @class */ (function (_super) {
    ...
    function IrcClient(options) {
        ...
        _this._logger = new logger_1.Logger(tslib_1.__assign({ name: 'ircv3', emoji: true }, logger));
        ...
        if (reconnect) {
            _this._connection = new connection_1.PersistentConnection(ConnectionType, connectionOptions, { logger: _this._logger });
        }
        else {
            _this._connection = new ConnectionType(connectionOptions);
        }
        try {
        ...
        _this.onTypedMessage(Commands_1.CapabilityNegotiation, function (_a) {
            ...
            return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var caps, _c, capList, _d, _e, _f, name_1, cap, capNames_1, caps_1, caps_1_1, cap;
                var e_3, _g, e_4, _h;
                        ...
                        case 1:
                            ...
                            try {
                                for (_d = tslib_1.__values(Object.entries(capList)), _e = _d.next(); !_e.done; _e = _d.next()) {
                                    _f = tslib_1.__read(_e.value, 2), name_1 = _f[0], cap = _f[1];
                                    this._serverCapabilities.set(name_1, cap);
                                }
                            }
        ...
        _this.onTypedMessage(Numerics_1.Error462AlreadyRegistered, function () {
                ...
                this._connection.onConnect(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _a = tslib_1.__read.apply(void 0, [_b.sent(), 1]), password = _a[0];

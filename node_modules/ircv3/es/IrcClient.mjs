...
import { Error462AlreadyRegistered, Reply001Welcome, Reply004ServerInfo, Reply005Isupport } from "./Message/MessageTypes/Numerics/index.mjs";
...
var IrcClient = /** @class */ (function (_super) {
    ...
    function IrcClient(options) {
                        ...
                        case 1:
                            ...
                            try {
                                for (_d = __values(Object.entries(capList)), _e = _d.next(); !_e.done; _e = _d.next()) {
                                    _f = __read(_e.value, 2), name_1 = _f[0], cap = _f[1];
        ...
        _this.onTypedMessage(Error462AlreadyRegistered, function () {
    ...
    IrcClient.prototype.say = function (target, message) {
        this.sendMessage(PrivateMessage, { target: target, message: message });
    };
